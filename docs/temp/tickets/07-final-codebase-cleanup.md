...
- [ ] Runtime behaviour and tests agree that local system time determines the current period and that each Habit can earn one five-XP Milestone on first reaching a seven-period Streak, retained through archive and restoration and removed by permanent deletion.
